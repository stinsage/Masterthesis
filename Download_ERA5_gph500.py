...
if __name__ == "__main__":
	#variables_single_layer = ['surface_latent_heat_flux']
	variables_pressure_layer = ['geopotential']
	level = 500
	...
	for var in variables_pressure_layer:
		for subset in y_lop:
			download_pressure_layer_file(var, level, subset.tolist())			
